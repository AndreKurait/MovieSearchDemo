...
export default function Header() {
  return (
    <header className="sticky top-0 z-40 bg-bg-header backdrop-blur-md border-b border-border-secondary">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6">
        ...
        {/* Semantic slider row - visible on desktop */}
        <div className="hidden md:flex items-center justify-center pb-3">
          <SemanticSlider />
        </div>

        {/* Mobile slider - below header on small screens */}
